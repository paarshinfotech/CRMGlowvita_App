...
class _SuppInvoiceManagementPageState extends State<SuppInvoiceManagementPage> {
  ...
  int get totalProductsSold => invoices.fold(
      ...
      (sum, i) =>
          sum +
          (i['products'] as List)
              .fold(0, (s, p) => s + (p['quantity'] as int)));
    ...
    return invoices.where((invoice) {
      ...
      final matchesPaymentMethod =
          _selectedPaymentMethod == 'All Payment Methods' ||
              invoice['paymentMethod'].toString().contains(
                  _selectedPaymentMethod.replaceAll('All Payment Methods', ''));
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                        ...
                        children: [
                          Text('My Product Invoices',
                              style: GoogleFonts.poppins(
                                  fontSize: 13, fontWeight: FontWeight.w600)),
                          Text('$totalBills invoices',
                              style: GoogleFonts.poppins(
            ...
            Expanded(
              child: filteredInvoices.isEmpty
                  ? Center(
                      child: Text('No product invoices found',
                          style: GoogleFonts.poppins(
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (_, i) => SuppInvoiceCard(
                        ...
                        onDelete: () =>
                            _confirmDeleteInvoice(filteredInvoices[i]['id']),
                      ),
                    ),
            ),
          ],
...
class SuppInvoiceCard extends StatelessWidget {
  ...
  const SuppInvoiceCard(
      {super.key, required this.invoice, this.onView, this.onDelete});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(invoice['email'],
                style:
                    GoogleFonts.poppins(fontSize: 10, color: Colors.grey[700])),
            const SizedBox(height: 8),
            Row(
              children: [
                Text('Products:',
...
class SuppInvoiceDetailsDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final subtotal = products.fold(
        0.0, (sum, p) => sum + (p['price'] as double) * (p['quantity'] as int));
                  ...
                  child: Row(
                      ...
                      children: [
                        Text('${p['name']} (x${p['quantity']})',
                            style: GoogleFonts.poppins(fontSize: 12)),
                        Text(
                            '₹${((p['price'] as double) * (p['quantity'] as int)).toStringAsFixed(0)}',
                            style: GoogleFonts.poppins(fontSize: 12)),
                      ]),
                )),
            const Divider(),
