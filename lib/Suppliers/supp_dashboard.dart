    ...
    return Column(children: [
      SizedBox(
        ...
        child: CustomPaint(
          ...
          child: Center(
              child: Text('${(value * 5).toStringAsFixed(1)}',
                  style:
      ...
      Container(
        ...
        decoration: BoxDecoration(
            color: labelBg, borderRadius: BorderRadius.circular(100)),
        child: Text(label,
            style: TextStyle(
                fontSize: 8.sp,
                fontWeight: FontWeight.w600,
...
class _GaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius),
        math.pi * 0.75, math.pi * 1.5, false, bgP);
    ...
    final fgP = Paint()
      ...
      ..strokeWidth = 6;
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius),
        math.pi * 0.75, math.pi * 1.5 * value, false, fgP);
  }
...
class _LegendDot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      SizedBox(width: 4.w),
      Text(label, style: TextStyle(fontSize: 7.sp, color: Colors.grey[600])),
    ]);
  }
}
