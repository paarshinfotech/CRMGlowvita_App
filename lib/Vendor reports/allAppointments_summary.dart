    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Prominent search and buttons row matching Figma exactly
            ...
            ReportStatsGrid(
              children: [
                ...
                ReportStatCard(
                  ...
                  circleBgColor: const Color(0xFFFEF2F2),
                ),
                ReportStatCard(
                  label: 'Total Revenue',
                  value: _fmtCompact(_totalRevenue),
                ...
                ReportStatCard(
                  ...
                  value: _fmtCompact(_totalBusiness),
