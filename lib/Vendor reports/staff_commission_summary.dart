...
class _StaffCommissionSummaryState extends State<StaffCommissionSummary> {
  ...
  Widget build(BuildContext context) {
    double totalEarned = _filtered.fold(0.0, (sum, s) => sum + s.totalCommissionEarned);
    double totalPaid = _filtered.fold(0.0, (sum, s) => sum + s.totalPaidOut);
    double totalBal = _filtered.fold(0.0, (sum, s) => sum + s.netCommissionBalance);
