...
class _SettlementsPageState extends State<SettlementsPage> {
  ...
  List<Map<String, dynamic>> _mockTransactionsFor(String salon) {
    if (salon == 'Glamour Salon') {
      return [
        {'title': 'Service Payment', 'date': DateTime(2025, 8, 10), 'amount': 500.0},
        {'title': 'Membership Fee', 'date': DateTime(2025, 8, 5), 'amount': 1000.0},
        {'title': 'Vendor Payout', 'date': DateTime(2025, 8, 12), 'amount': -1200.0},
      ];
    } else if (salon == 'Modern Cuts') {
      return [
        {'title': 'Package Sale', 'date': DateTime(2025, 7, 28), 'amount': 1500.0},
        {'title': 'Vendor Payout', 'date': DateTime(2025, 7, 30), 'amount': -1000.0},
        {'title': 'Adjustment', 'date': DateTime(2025, 8, 2), 'amount': -500.0},
      ];
    } else {
      return [
        {'title': 'Service Payment', 'date': DateTime(2025, 8, 1), 'amount': 800.0},
        {'title': 'Commission', 'date': DateTime(2025, 8, 3), 'amount': -300.0},
        {'title': 'Vendor Payout', 'date': DateTime(2025, 8, 6), 'amount': -200.0},
      ];
    }
  }
        ...
        child: Column(
          children: [
            ...
            _sectionHeader(
              ...
              subtitle: 'Details of all settlements for online payments and platform fees.',
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _money('Total Settlement (₹)', r['totalSettlement'], emphasize: true),
                          ],
                        ),
                      ],
                    ),
    ...
    if (text.isNotEmpty) {
      ...
      if (entered != null && entered > maxPending) {
        ...
        amountController.value = TextEditingValue(
          ...
          selection: TextSelection.collapsed(offset: maxPending.toStringAsFixed(2).length),
        );
      }
    }
  }
